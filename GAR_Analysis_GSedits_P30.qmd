...
ReplicateAverages_PV <- Image_data2 |>
  group_by(GT, Animal) |>
  summarise(
    PV_avg = mean(`Green.Puncta.Count`, na.rm = TRUE),
    .groups = "drop"
  )

# Total averages per genotype (this is what you want for bars)
TotalAverages_PV <- ReplicateAverages_PV |>
  group_by(GT) |>
  summarise(
...
# Set factor order ONCE (and only on objects that actually have GT)
Image_data2 <- Image_data2 |>
  mutate(GT = factor(GT, levels = c("WT", "KO")))

ReplicateAverages_PV <- ReplicateAverages_PV |>
  mutate(GT = factor(GT, levels = c("WT", "KO")))

TotalAverages_PV <- TotalAverages_PV |>
  mutate(GT = factor(GT, levels = c("WT", "KO")))
...
superplot_PV <- ggplot() +
  geom_quasirandom(
    data = Image_data2,
    aes(x = GT, y = `Green.Puncta.Count`, color = GT),
    size = 2, width= 0.2, alpha = 0.5
  ) +
  geom_col(  # same as geom_bar(stat="identity"), a bit cleaner
    data = TotalAverages_PV,
    aes(x = GT, y = PV_avg_avg, fill = GT),
    width = 0.2, alpha = 0.25
  ) +
  stat_summary(
    data = ReplicateAverages_PV,
    aes(x = GT, y = PV_avg),
  ...
  coord_cartesian(ylim = c(0, 350))  # safer than ylim()
...
superplot_WFA <- ggplot() +
  ...
  geom_quasirandom(data = Image_data2, aes(x = GT, y = `Red.Puncta.Count`, color = GT), width = 0.2, size = 2, alpha = 1/2) +
  # Bar plot for total averages
  geom_bar(data = TotalAverages_WFA, aes(x = GT, y = WFA_avg_avg, fill = GT), stat = "identity", width = 0.2, alpha = 0.25) +
  ...
  geom_point(data = ReplicateAverages_WFA, aes(x = GT, y = WFA_avg, color = GT), width = 0.2, size = 4, alpha = 0.5) +
  # Theme and labels
  theme(
...
ggsave(filename = "./Plots_all_sets/p30_Ctnnd2_superplot_WFA.png", width = 4, height = 6)
...
superplot_double_pos <- ggplot() +
  # Plot original data points with `Green Puncta Count`
  geom_quasirandom(data = Image_data2, aes(x = GT, y = `Colocalized.Puncta.Count`, color = GT), width = 0.2, size = 2, alpha = 1/2) +
  # Bar plot for total averages
  geom_bar(data = TotalAverages_double_pos, aes(x = GT, y = double_pos_avg_avg, fill = GT), stat = "identity", width = 0.2, alpha = 0.25) +
  # Error bars for replicate averages
  ...
  # Points for replicate averages
  geom_point(data = ReplicateAverages_double_pos, aes(x = GT, y = double_pos_avg, color = GT), width = 0.2, size = 4, alpha = 0.5) +
  # Theme and labels
  theme(
    legend.text = element_text(size = 6),
    legend.title = element_text(size = 8)
...
ggsave(filename = "./Plots_all_sets/p30_Ctnnd2_superplot_double_pos.png", width =4, height = 6)
...
superplot_single_pos <- ggplot() +
  # Plot original data points with `Green Puncta Count`
  geom_quasirandom(data = Image_data2, aes(x = GT, y = (single_pos), color = GT), width = 0.2, size = 2, alpha = 1/2) +
  # Bar plot for total averages
  geom_bar(data = TotalAverages_single_pos, aes(x = GT, y = single_pos_avg_avg, fill = GT), stat = "identity", width = 0.2, alpha = 0.25) +
  # Error bars for replicate averages
  ...
  # Points for replicate averages
  geom_point(data = ReplicateAverages_single_pos, aes(x = GT, y = single_pos_avg, color = GT), width = 0.2, size = 4, alpha = 0.5) +
  # Theme and labels
  theme(
    legend.text = element_text(size = 6),
    legend.title = element_text(size = 8)
...
ggsave(filename = "./Plots_all_sets/p30_Ctnnd2_superplot_single_pos.png", width =4, height = 6)
...
superplot_pct_double <- ggplot() +
  # Plot original data points with `Green Puncta Count`
  geom_quasirandom(data = Image_data2, aes(x = GT, y = (pct_double), color = GT), width = 0.2, size = 2, alpha = 1/2) +
  # Bar plot for total averages
  geom_bar(data = TotalAverages_pct_double, aes(x = GT, y = pct_double_avg_avg, fill = GT), stat = "identity", width = 0.2, alpha = 0.25) +
  # Error bars for replicate averages
  ...
  # Points for replicate averages
  geom_point(data = ReplicateAverages_pct_double, aes(x = GT, y = pct_double_avg, color = GT), width = 0.2, size = 4, alpha = 0.5) +
  # Theme and labels
  theme(
    legend.text = element_text(size = 6),
    legend.title = element_text(size = 8)
...
ggsave(filename = "./Plots_all_sets/p30_Ctnnd2_superplot_pct_double.png", width = 4, height = 6)
